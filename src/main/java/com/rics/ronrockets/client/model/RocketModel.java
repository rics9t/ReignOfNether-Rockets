...
public class RocketModel extends EntityModel<RocketEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bb_main =
                partdefinition.addOrReplaceChild(
                        ...
                        CubeListBuilder.create()
                                .texOffs(0, 0)
                                .addBox(-4.0F, -37.0F, -4.0F,
                                        8.0F, 32.0F, 8.0F,
                                        new CubeDeformation(0.0F))
                                .texOffs(32, 38)
                                .addBox(-3.0F, -5.0F, -3.0F,
                                        6.0F, 2.0F, 6.0F,
                                        new CubeDeformation(0.0F))
                                .texOffs(32, 22)
                                .addBox(-3.0F, -47.0F, -3.0F,
                                        6.0F, 10.0F, 6.0F,
                                        new CubeDeformation(0.0F)),
        ...
        bb_main.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(32, 11)
                        .addBox(-21.0F, -2.0F, -1.0F,
                                22.0F, 9.0F, 2.0F,
                                new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(
                        -3.0F, -31.0F, 1.0F,
                        0.0F, -0.0873F, -0.1745F)
        );
        ...
        bb_main.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(40, 46)
                        .addBox(-5.0F, -6.0F, -1.0F,
                                8.0F, 6.0F, 2.0F,
                                new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(
                        0.0F, -5.0F, 4.0F,
                        -1.5708F, 1.3963F, -1.5708F)
        );
